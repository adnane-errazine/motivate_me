...
class Agent_applications_finder:
    ...
    async def _find_applications_node(self, state: WorkflowState) -> WorkflowState:
            ...
            try:
                ...
                for concept in state["significant_concepts"]:
                    ...
                    messages = [
                        {"role": "system", "content": "You are an expert at connecting abstract mathematical/scientific concepts to exciting real-world applications that inspire learning."},
    ...
    async def run(self, state: WorkflowState) -> WorkflowState:
        ...
        state = await self._find_applications_node(state)
...
if __name__ == "__main__":
    ...
    agent = Agent_applications_finder()
